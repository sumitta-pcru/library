...
$sql = "select *
        ...
        inner join member m on m.m_id = bw.m_id  WHERE bw.bw_id LIKE '%$name%' or m.m_name LIKE '%$name%' or b.b_name LIKE '%$name%' or bw.bw_date LIKE '%$name%' or bw.bw_returndate LIKE '%$name%' or bd.bd_status LIKE '%$name%' ";
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="btn btn-light"  href="test2.php?bk_id=<?php echo $rs1->bw_id;?>">
