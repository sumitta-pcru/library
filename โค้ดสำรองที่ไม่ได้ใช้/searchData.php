...
$sql = "select *
            ...
            inner join booklist bl on bl.b_id = b.b_id WHERE bl.bl_id LIKE '%$name%' or b.b_name LIKE '%$name%' or bc.bc_name LIKE '%$name%' or b.b_author LIKE '%$name%' or b.b_year LIKE '%$name%' or b.b_place LIKE '%$name%' ";
        ...
        ?>
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="margin-top: 20px">รายงานหนังสือทั้งหมด</h1>
                        
                        <form id="form1" name="form1" class="form-inline" method="post" action="searchData.php">
