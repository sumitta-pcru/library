...
$sql = "select bl.bl_id,b.b_name,b.b_pic,bc.bc_name,COUNT(bl.bl_id) as num
            ...
            where DATE_FORMAT(bs.bk_date,'%Y') = $bk_date 
        ...
        ?>
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="margin-top: 20px">รายงานสถิติการจอง</h1>
                        <form id="form1" name="form1" class="form-inline" method="post" action="searchking.php">
                                <div class="form-group">
                                    <label for="exampleInputName2">ปี &nbsp;</label>
                                    
                                    <select class="custom-select" name="bk_date" id="bk_date">
                                                <?PHP for($i=-4; $i<=2; $i++){ ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="100" align="center">สถิติการจอง</td>
