                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="container" align="center" >
                                        <form  action="deleteusertype.php" method="post" enctype="multipart/form-data"  style="margin-top: 10px;">
                                            <input hidden="ut_id" type="hidden" name="ut_id" value="<?php echo "$rs[ut_id]"?>">
                                                <!-- Form Name -->
                                                <legend><center><h2><b>ลบข้อมูลประเภทผู้ใช้</b></h2></center></legend><br>
                                                <!-- Text input-->
                                                ...
                                                <span style="padding-left:370px"></span>
                                                    <div class="col-md-4 mb-3" align="left">
                                                        ...
                                                        <input name="ut_name" id="ut_name" value="<?php echo "$rs[ut_name]";?>" type="text" class="form-control"
                                                               placeholder="กรุณาใส่ชื่อประเภท" aria-label="ชื่อประเภท" aria-describedby="basic-addon1"readonly>
                                                    </div>
                                            </div>
                                            <div class="form-row" style="margin-top: 20px">
                                                <span style="padding-left:370px"></span>
                                                <div class="col-md-4 mb-3" align="left">
                                                    ...
                                                    <input type="text" class="form-control"  name="ut_date" id="ut_date" value="<?php echo "$rs[ut_date]";?>"
                                                           placeholder="กรุณาใส่จำนวนวันที่ยืม"  aria-describedby="basic-addon1"readonly>
                                                </div>
                                            </div>
                                            <div class="form-row" style="margin-top: 20px">
                                                <span style="padding-left:370px"></span>
                                                <div class="col-md-4 mb-3" align="left">
                                                    ...
                                                    <input type="text" class="form-control"  name="ut_rate" id="ut_rate" value="<?php echo "$rs[ut_rate]";?>"
                                                           placeholder="กรุณาใส่อัตราค่าปรับ"  aria-describedby="basic-addon1"readonly>
                                                </div>
                                            </div>
                                            <div class="form-row" style="margin-top: 20px">
                                                <span style="padding-left:370px"></span>
                                                <div class="col-md-4 mb-3" align="left">
                                                    ...
                                                    <input type="text" class="form-control"  name="ut_advance" id="ut_advance" value="<?php echo "$rs[ut_advance]";?>"
                                                           placeholder="กรุณาใส่ระยะเวลาจองล่วงหน้า"  aria-describedby="basic-addon1"readonly>
                                                </div>
                                            </div>
                                            <div class="form-row" style="margin-top: 20px">
                                                <span style="padding-left:370px"></span>
