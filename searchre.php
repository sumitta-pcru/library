...
$sql = "select *
            ...
            inner join member m on m.m_id = bw.m_id WHERE bd.bd_status= $bd_status";
...
?>
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="margin-top: 20px">รายงานข้อมูลการยืม-คืน</h1>
                        <form id="form1" name="form1" class="form-inline" method="post" action="searchre.php">
                            <div class="form-group">
                                <label for="exampleInputName2">สถานะ &nbsp;</label>
                                    <select class="custom-select" name="bd_status" id="bd_status" style="width: 100px;">
                                         
                                            <option value="0">คืนแล้ว</option>
