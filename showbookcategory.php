                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>      
                             				<td width="85" align="center">รหัสหมวดหมู่</td>
                            				<td width="85" align="center">ชื่อหมวดหมู่</td>
                                    ...
                                    while ($rs = mysql_fetch_object($result)) {
                                        ?>
                                        <tr>
                                            <td align="center"><?php echo"$rs->bc_id";?></td>
                                            <td align="center"><?php echo"$rs->bc_name";?></td>

                                            <td align="center">
                                                <a class="btn btn-warning"  href="frm_editbookcategory.php?bc_id=<?php echo $rs->bc_id;?>">
                                                    <i class="fas fa-pen"></i> แก้ไข
                                                </a>
                                                <a class="btn btn-danger"  href="frm_debookcategory.php?bc_id=<?php echo $rs->bc_id;?>">
