        ...
        ?>
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="margin-top: 20px">รายงานหนังสือแยกตามหมวดหมู่</h1>
                        <form id="form1" name="form1" class="form-inline" method="post" action="searchcate.php">
                                <div class="form-group">
                                    <label for="exampleInputName2">สถานะ &nbsp;</label>
                                    
                                        <select class="custom-select" name="bc_id" id="bc_id" ">
                                        
                                            <option value="000">วิทยาการคอมพิวเตอร์ สารสนเทศ และความรู้ทั่วไป</option>
                                            <option value="100">ปรัชญาและจิตวิทยา</option>
                                            <option value="200">ศาสนา</option>
                                            <option value="300">สังคมศาสตร์</option>
                                            <option value="400">ภาษา</option>
                                            <option value="500">วิทยาศาสตร์</option>
                                            <option value="600">เทคโนโลยีหรือวิทยาศาสตร์ประยุกต์</option>
                                            <option value="700">ศิลปะและการบันเทิง</option>
                                            <option value="800">วรรณกรรม</option>
                                            <option value="900">ประวัติศาสตร์และภูมิศาสตร์</option>
                                        </select>&nbsp;&nbsp;
