...
$bw_date = $_POST["bw_date"];

$sql = "select bl.bl_id,b.b_name,b.b_pic,bc.bc_name,COUNT(bt.bl_id) as num 
            FROM borrowingdetails bt inner join  borrowing bw on bt.bw_id=bw.bw_id
            ...
            where DATE_FORMAT(bw.bw_date,'%Y') = $bw_date 
            group by bl.bl_id order by num DESC";


        //where DATE_FORMAT(bw_date,'%Y') = $bw_date 
        //DATE_FORMAT(bw_date,'%Y') -> YYYY
        //DATE_FORMAT(bw_date,'%Y-%m-%d') -> YYYY-mm-dd ปี-เดือน-วัน
        ...
        ?>
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="margin-top: 20px">รายงานสถิติการยืม</h1>
                        <form id="form1" name="form1" class="form-inline" method="post" action="searchbor.php">
                                <div class="form-group">
                                    <label for="exampleInputName2">ปี &nbsp;</label>
                                        <select class="custom-select" name="bw_date" id="bw_date">
                                                <?PHP for($i=-4; $i<=1; $i++){ ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="100" align="center">สถิติการยืม</td>
                                    ...
                                    while ($rs1 = mysql_fetch_object($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo"$rs1->num";?></td>
