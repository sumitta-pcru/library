                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="container" align="center" >
                                        <form  action="deletebookcategory.php" method="post" enctype="multipart/form-data"  style="margin-top: 10px;"  >
                                                <!-- Form Name -->
                                                <legend><center><h2><b>ลบข้อมูลหมวดหมู่หนังสือ</b></h2></center></legend><br>
                                                <!-- Text input-->
                                            ...
                                            <div class="form-row" style="margin-top: 20px">
                                                ...
                                                <div class="col-md-4 mb-3" align="left">
                                                    ...
                                                    <input name="bc_name" id="bc_name" value="<?php echo "$rs[bc_name]";?>" type="text" class="form-control"
                                                           placeholder="กรุณาใส่ชื่อหมวดหมู่" aria-label="Department name" aria-describedby="basic-addon1"readonly>
                                                </div>
                                            </div>
