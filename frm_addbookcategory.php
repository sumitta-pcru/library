                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="container" align="center" >
                                        <form  action="addbookcategory.php" method="post" enctype="multipart/form-data"  style="margin-top: 10px;"  >
                                                <!-- Form Name -->
                                                <legend><center><h2><b>เพิ่มข้อมูลหมวดหมู่หนังสือ</b></h2></center></legend><br>
                                                <!-- Text input-->
                                            <div class="form-row" style="margin-top: 20px">
                                                <span style="padding-left:360px"></span>
                                                    <div class="col-md-4 mb-3" align="left">
                                                        ...
                                                        <input name="bc_id" id="bc_id" type="text" class="form-control"
                                            ...
                                            <div class="form-row" style="margin-top: 20px">
                                                ...
                                                <div class="col-md-4 mb-3" align="left">
                                                    ...
                                                    <input name="bc_name" id="bc_name" type="text" class="form-control"
