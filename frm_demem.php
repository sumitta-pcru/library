                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    <div class="container" align="center" >
                                        <form  action="deletemem.php" method="post" enctype="multipart/form-data"  style="margin-top: 10px;"  >
                                                <!-- Form Name -->
                                                <legend><center><h2><b>ลบข้อมูลสมาชิก</b></h2></center></legend><br>
                                                <!-- Text input-->
                                            <div class="form-row" style="margin-top: 20px">
                                                <span style="padding-left:150px"></span>
                                                    <div class="col-md-4 mb-3" align="left">
                                                        ...
                                                        <input type="text" class="form-control" value="<?php echo "$rs[m_id]";?>" name="m_id" id="m_id" placeholder="กรุณาใส่รหัสผู้ใช้"
