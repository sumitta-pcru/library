                                    ...
                                    <div class="form-group row" align="center">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control select2" name="bl_id" id="bl_id">
                                                ...
                                                <?php
                                                $sql1 = "SELECT * from booklist bl,book b where b.b_id=bl.b_id and  bl.bl_status = '0'  ";
                                                $result1 = mysql_query($sql1, $conn);
                                                while ($rs1 = mysql_fetch_array($result1)) {
                                                    echo "<option value = $rs1[bl_id]>$rs1[b_name]</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                    ...
                    <div class="container-fluid">
                        <div class="card-body">
                            <div class="table-responsive" style="margin-top: -20px;">
                                <div class="container">
                                <form  action="addborrowing.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group row" align="center">
                                            <span style="padding-left:100px"></span>
                                        ...
                                        <div align="center">
                                            <td align="center">
                                                ...
                                                <button type="button" name="Submit2"
                                                    onclick="window.location='delshop.php';" class="btn btn-danger">
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($_SESSION['shopping_cart'])) {
                                                ...
                                                foreach ($_SESSION['shopping_cart'] as $bl_id) {
                                                    ...
                                                    // $sqlcart = "SELECT COUNT(bl_id) FROM booklist  where bl_id = '".$_SESSION['shopping_cart']."' ";
                                                    ...
                                                    echo "<td align='center'><a  href='deleteshop.php?bl_id=$bl_id&act=remove'><i class='fas fa-trash-alt' style='color:#EC7063'></i></a></td>";
                                                    echo "</tr>";
                                                }
                                            }
                                            ?>
