        ...
        ?>
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"  style="margin-top: 20px">ข้อมูลสถานที่พิมพ์</h1>
                    </div>

                    <div class="mb-5" style="text-align: left">
				    <a  class="btn btn-success" href="frm_addprintloca.php">
                        <i class="fas fa-plus-circle"></i> เพิ่มข้อมูลสถานที่พิมพ์
                    </a>
                	</div>
                    <!-- Content Row -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>      
                             				<td width="85" align="center">รหัสสถานที่พิมพ์</td>
                            				<td width="85" align="center">ชื่อสถานที่พิมพ์</td>
                                    ...
                                    while ($rs = mysql_fetch_object($result)) {
                                        ?>
                                        <tr>
                                            <td align="center"><?php echo"$rs->lo_id";?></td>
                                            <td align="center"><?php echo"$rs->lo_name";?></td>

                                            <td align="center">
                                                <a class="btn btn-warning"  href="frm_editprintloca.php?lo_id=<?php echo $rs->lo_id;?>">
                                                    <i class="fas fa-pen"></i> แก้ไข
                                                </a>
                                                <a class="btn btn-danger"  href="frm_delprintloca.php?lo_id=<?php echo $rs->lo_id;?>">
