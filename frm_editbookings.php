...
$sql = "select *
           ...
           inner join book b on b.b_id = bl.b_id  and bk.bk_id ='$bk_id'";
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item active" aria-current="page">
                                จัดการแก้ไขข้อมูลการจองหนังสือ
                            </li>
                        </ol>
                    </nav>
                </div>
            </div>
            <sup><h6 class="mb-0" style="margin-top: 20px">จัดการแก้ไขข้อมูลการจองหนังสือ</h6></sup>
            <hr>
            <div class="card">
                <div class="card-header" align="center">
                   <h4>แก้ไขข้อมูลการจองหนังสือ</h4>
                </div>
                <div class="card-body">
                    <form action="addmem.php" method="post" enctype="multipart/form-data" style="margin-top: 10px; margin-bottom: 10px;">
                        ...
                        <table class="table" style="width: 50%; height: 100%"  align="center" >
                            <tr>
                                <div class="form-group row" align="center">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" value="<?php echo "$rs[bk_id]";?>" name="bk_id" id="bk_id"
                            ...
                            <tr>
                                <div class="form-group row" align="center">
                                    ...
                                    <div class="col-sm-6">
                                        <select  class="custom-select" name="bl_id" id="bl_id" >
                                            <?php
                                            $sql1 = "select * FROM bookingdetails where  bl_id and bk_id='$bk_id' ";
